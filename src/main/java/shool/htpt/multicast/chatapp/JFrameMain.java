    ...
    private void jButtonConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConnectActionPerformed
        try {
            if (!jTextFieldAddress.getText().equalsIgnoreCase("") && !jTextFieldPort.getText().equalsIgnoreCase("")) {
                receiverRunner = new ReceiverRunner(jTextFieldAddress.getText(), Integer.parseInt(jTextFieldPort.getText()));
                senderRunner = new SenderRunner(jTextFieldAddress.getText(), Integer.parseInt(jTextFieldPort.getText()));
            } else {
